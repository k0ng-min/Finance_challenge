...
#   - 가격 축은 과하게 주지 않는다. 자료가 없는 보험사는 이 축을 빼고 나머지로 다시
#     100%를 맞추므로, 비중이 크면 그 보정의 영향도 커진다. 2026-08-25에 DB손해보험과
#     신한EZ손해보험 보험료가 차례로 들어오면서 7개사 전부 가격이 채워져 지금은 보정이
#     걸리지 않지만, 보험사를 새로 추가하면 그 사이 다시 걸린다 — 그래서 비중은 그대로 둔다.
# ---------------------------------------------------------------------------
axis_weights <- list(
