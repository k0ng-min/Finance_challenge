...
- **등급에 따라 보장금액이 다르므로, 등급이 바뀌면 순위도 바뀔 수 있습니다.** {plan_tier_label} 등급의
  보장금액을 실제로 비교해서 점수에 반영하세요. 등급과 무관하게 늘 같은 순서를 내면 안 됩니다.
- 각 보험사마다 왜 그 점수인지 자연스러운 문장 2~3개로 쓰세요.
